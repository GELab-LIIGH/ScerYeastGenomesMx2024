######################################
##                                  ##
##Automatization to obtain figure 3A##
##                                  ##
######################################
...
gff_folder="../../../figure1/fig1C/pipeline/data/ref/"
data_folder="data/"
...
Rscript bin/scripts/graph.R data/introgressions/ phylogeny.csv data/introgressions/graph.pdf
