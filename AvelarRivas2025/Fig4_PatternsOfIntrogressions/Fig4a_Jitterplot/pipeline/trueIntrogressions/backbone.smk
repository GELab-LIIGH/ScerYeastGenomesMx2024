...
rule merge_core:
    input:
        expand("data/vcfs/{sample}.vcf",sample = strains)
    params:
...
rule index:
    input:
        rules.merge_core.output
    output:
        "data/vcfs/Matrix_core.g.vcf.gz.csi"
    shell:
        """
        module load bcftools/1.9
...
rule cut_vcfs:
    ...
    output:
        cut_matrix = temp("data/vcfs/backbone/Matrix_backbone_{intro}_noGT_combinedgvcfs_cut.g.vcf")
    shell:
        """
        module load bcftools/1.9
...
rule genotype:
    ...
    output:
        temp("data/vcfs/backbone/Matrix_backbone_{intro}_combinedgvcfs_genotype.vcf")
    shell:
        """
        module load gatk/4.1.6.0
...
rule select_SNPS:
    ...
    output:
        temp("data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs.vcf")
    shell:
        """
        module load gatk/4.1.6.0
...
rule filter_low:
    ...
    output:
        temp("data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow.vcf")
    shell:
        """
        module load gatk/4.1.6.0
...
rule remove_filtered:
    ...
    output:
        temp("data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow_filteredSNPs.vcf")
    params:
        # these are intermediate files
        to_recode = "data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow_filteredSNPs",
        recoded = "data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow_filteredSNPs.recode.vcf"
    shell:
        """
        module load vcftools/0.1.14
...
rule missing_sites:
    ...
    output:
        temp("data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow_filteredSNPs_missing10.vcf")
    params:
        to_recode = "data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow_filteredSNPs_missing10",
        recoded = "data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow_filteredSNPs_missing10.recode.vcf",
...
rule keep_biallelic:
    ...
    output:
        "data/vcfs/backbone/Matrix_backbone_{intro}_combinegvcfs_genotype_onlySNPs_filterlow_filteredSNPs_missing40_biallelic.vcf"
    shell:
        """
        module load bcftools/1.9
...
rule vcf2phylip:
    ...
    params:
        prefix = "data/phyl/backbone/Matrix_backbone_{intro}_filteredSNP_10missing_biallelic"
    output:
        "data/phyl/backbone/Matrix_backbone_{intro}_filteredSNP_10missing_biallelic.phy"
    shell:
        """
...
rule phylo_tree:
    ...
    output:
        best = "data/phyl/backbone/Matrix_backbone_{intro}_filteredSNP_10missing_biallelic.phy.contree"
    params:
        model = "MFP",
        LikelihoodRate = 1000,
        bootstrap = 1000
    ...
    shell:
        ...
        iqtree2 -s {input} -m {params.model} -T {threads}  -bb {params.bootstrap} -alrt {params.LikelihoodRate} --seqtype DNA
        """
shared_df = pd.read_csv(shared, sep='\t')

rule all:
    input:
        expand("data/phyl/backbone/Matrix_backbone_{intro}_filteredSNP_10missing_biallelic.phy.contree",intro = shared_df["Gene"].unique())
